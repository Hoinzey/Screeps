...
module.exports.loop = function () {
    ...
    if(Game.flags.Siege!=undefined){
        if(Memory.siegeRoom==undefined){
            let siegeObject = {name: Game.flags.Siege.pos.roomName,scouted:false,enemiesPresent:false,claim: false,claimed: false,hostileCount: 0};
            Memory.siegeRoom = siegeObject;
        }
    }else{
        Memory.siegeRoom = undefined;
    }
